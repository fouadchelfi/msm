  ...
  template: `
    <div class="flex w-screen h-screen items-center justify-center bg-primary">
      <div class="flex flex-col gap-y-1 bg-white w-[400px] h-fit p-6 rounded shadow-md">
        <div class="flex flex-row justify-center items-center self-center gap-x-2 text-center">
          <img src="./assets/icons/logo.png" alt="logo" class="h-10 w-16" />
        <div class="text-xl font-medium">Connectez-vous</div>
        </div>
...
export class LoginComponent {
  ...
  constructor(private authHttp: AuthHttpService, private router: Router, private fb: FormBuilder) {
