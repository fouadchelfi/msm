export declare class IngredientsController {
    getAllIngredients(): Promise<import("typeorm").ObjectLiteral[]>;
    getOneCategoyById(id: number): Promise<import("typeorm").ObjectLiteral>;
    paginateIngredient(query: any): Promise<{
        order: any;
        sort: any;
        pageIndex: number;
        pageSize: number;
    ...
    createIngredient(body: any, currentUser: any): Promise<{
        success: boolean;
        errors: any[];
        data: any;
    } | {
    ...
    updateIngredient(id: number, body: any, currentUser: any): Promise<{
        success: boolean;
        errors: any[];
        data: any;
    } | {
