export declare class FamiliesController {
    getAllFamilies(): Promise<import("typeorm").ObjectLiteral[]>;
    getOneCategoyById(id: number): Promise<import("typeorm").ObjectLiteral>;
    paginateFamily(query: any): Promise<{
        order: any;
        sort: any;
        pageIndex: number;
        pageSize: number;
    ...
    createFamily(body: any, currentUser: any): Promise<{
        success: boolean;
        errors: any[];
        data: any;
    } | {
    ...
    updateFamily(id: number, body: any, currentUser: any): Promise<{
        success: boolean;
        errors: any[];
        data: any;
    } | {
